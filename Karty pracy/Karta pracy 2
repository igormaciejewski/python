...
# Zad 4
# LIMIT = 20
# waga = int(input("Ile ważysz ciężarówko? "))
# if waga <= LIMIT:
#     print("Możesz wjechać")
# else:
#     print("Lepiej nie wjeżdżaj")

#Zad 5
# a, b, c = map(int, input().split())
# if (a < c and b > c) or (b < c and a > c):
#     print("TAK, SPEŁNIA WARUNKI")
# else:
#     print("NIE SPEŁNIA")
...
# if s*3 >= (k-p):
#     print("TAK, płaz da radę")
# else:
#     print("NIE, żaba nie dała rady.")
